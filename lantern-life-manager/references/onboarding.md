...
Then cover only relevant sections:
...
When installable Skills are unavailable, generate the Life Manager and Domain Coordinator Project instructions from the Project Kit. If the interface can create Projects and the user approves, offer to perform the setup. Otherwise give one instruction at a time.

## First useful output

Before offering optional apps or automation, provide:
